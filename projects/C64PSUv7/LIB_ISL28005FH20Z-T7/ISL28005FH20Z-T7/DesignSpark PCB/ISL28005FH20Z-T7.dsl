...
(library Library_1
	...
	(compDef "ISL28005FH20Z-T7" (originalName "ISL28005FH20Z-T7") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "RS-") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.renesas.com/en-us/www/doc/datasheet/isl28005.pdf")
		(attr "Height" "1.45 mm")
	)
