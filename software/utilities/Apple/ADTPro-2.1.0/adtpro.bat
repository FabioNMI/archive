...
:start
CD "%ADTPRO_HOME%"
start /min %MY_JAVA_HOME%java -Xms128m -Xmx256m %ADTPRO_EXTRA_JAVA_PARMS% -cp "%ADTPRO_HOME%lib\ADTPro-2.1.0.jar";"%ADTPRO_HOME%lib\AppleCommander\AppleCommander-1.3.5.13-ac.jar";"%ADTPRO_HOME%lib\jssc\jssc-2.9.2.jar";"%ADTPRO_HOME%lib\jssc\slf4j-nop-1.7.9.jar" org.adtpro.ADTPro %*
